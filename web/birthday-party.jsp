...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="pexels-cleyder-duque-3653948.jpg" alt="Los Angeles" width="1100" height="500">
    ...
    <div class="carousel-item">
      <img src="pexels-craig-adderley-1543762.jpg" alt="Chicago" width="1100" height="500">
      <div class="carousel-caption">
        <h3>Birthday</h3>
        <p>We make you special day more special just for you!</p>
      </div>   
    ...
    <div class="carousel-item">
      <img src="pexels-jill-wellington-433527.jpg" alt="New York" width="1100" height="500">
      <div class="carousel-caption">
        <h3>Birthday</h3>
        <p>We make you special day more special just for you!</p>
      </div>   
...
<div align="center">
  ...
  <table border="0"><tr>
  <td><input type="checkbox" name="compo" value="Gas Balloons">
  <label for="feartures1"> Gas Balloons</label></td><td>=Rs.1000</td></tr>
  <tr><td><input type="checkbox" name="compo" value="Painting">
  ...
  <tr><td><input type="checkbox" name="compo" value="Magic">
  ...
  <tr> <td> <input type="hidden" value="Birthday Party" name="type"></td></tr>
  <tr><td><input type="submit" value="Add Value"</td></tr>
